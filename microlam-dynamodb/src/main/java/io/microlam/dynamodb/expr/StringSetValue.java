...
public class StringSetValue implements Operand, ConstantValue {

	String[] values;
	
	public StringSetValue(String... values) {
		this.values = values;
	}
	...
	public String process(Map<String, AttributeValue> attributeValues, Map<String, String> attributeNames, AttributeNameGenerator attributeNameGenerator) {
		...
		attributeValues.put(name, AttributeValue.builder().ss(values).build());
		return name;
	}
